...
<div >
    ...
    <IoCaretBackOutline/> Dashboard
      ...
      {orders.length === 0 ? (
         ...
         <p className="text-gray-600 mb-6">Looks like you haven't placed <br /> any orders yet.</p>
         <button
              ...
              >
                <div className="bg-white rounded-xl p-0 md:p-4 mb-4 flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  {showCancelMobileModal && (
                    <div className="fixed inset-0 bg-black bg-opacity-30 z-50 transition-opacity duration-300 md:hidden">
                      {/* Background overlay */}
                      <div
                      ...
                      {/* Bottom sheet modal */}
                      <div
                        className={`fixed bottom-0 left-0 right-0 bg-white w-full max-w-md mx-auto rounded-t-2xl p-5 shadow-xl text-center transform transition-all duration-300
                        ${
                          animateModal
